...
<head>
    ...
    <title>Покупка - EstateAgency</title>
    ...
    <link rel="stylesheet" href="css/stylePurchase.css">
		...
		<script src="js/purchaseEstate/mainVue.js" defer></script>
...
<body>
    ...
    <!-- /#preloader.preloader -->
        ...
        <header>
            <div class="content"> <!-- контент в навигации -->
                ...
                <div class="links">
                    ...
                    <a href="/purchase" class="choosen">Покупка</a>
        ...
        <div id="purchase_content">
            <div id="purchase_form">
                    <div class="up-line">
                        ...
                        <div id="price">
                            <input class="min-price" type="number" min="4000000" max="40000000" v-model="minPrice" placeholder="от 4000000₽">
                            <input class="max-price" type="number" min="4000000" max="40000000" v-model="maxPrice" placeholder="до 40000000₽">
                        </div>
                    </div>
        ...
        <section>
                <div class="cards">
                    <div class="card" v-for="item in purchaseEstate">
                        <div class="info">
